...
namespace TooManyCrosshairs
{
    public class Gun : MonoBehaviour
    {
        ...
        public float shotsPerSecond; //how fast this gun_Perma shoots

        public Color specialColor;

        //used to set up how often the gun_Perma shoots as set in shotsPerSecond 
        float shotRate;
        float nextShotTime;
        ...
        void Start()
        {
            ...
            //sets behaviour of the crosshair to match the way the gun_Perma shoots
        ...
        void Shoot() //shoot the gun_Perma based on the fire rate set by setting shotsPerSecond
        {
