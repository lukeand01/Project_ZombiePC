...
namespace TooManyCrosshairs
{
    public class Crosshair : MonoBehaviour
    {
        ...
        public RawImage expanding; //the image that is expanded when the gun_Perma shoots
        ...
        float reloadSpeed;  // how fast the gun_Perma reloads in seconds
        ...
        // these public functions are used to set up the crosshair to function based on what the GUN object settings are (so that you can set different behaviour per gun_Perma)
